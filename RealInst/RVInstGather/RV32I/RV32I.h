...
{
    private:
        uint32_t rv32i_R_type(string *ptr_inst);
        uint32_t rv32i_I_type(string *ptr_inst);
        uint32_t rv32i_S_type(string *ptr_inst);
        uint32_t rv32i_B_type(string *ptr_inst);
        uint32_t rv32i_U_type(string *ptr_inst);
        uint32_t rv32i_J_type(string *ptr_inst);
    public:
